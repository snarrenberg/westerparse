...
#    source = 'TestScoresXML/BlankTest.musicxml'
...
#    source = 'WesterParseCorpora/WesterParseLineCorpus/WP001.musicxml'
...
#    source = '/Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/music21/corpus/essenFolksong/zuccal0.abc'
    ...
    def tester(source, verify):
								if verify == 1: # tests for generability as any type of line
												evaluateLines(source, show=None)
								elif verify == 2:
												evaluateCounterpoint(source, report=True)
												...
												context.evaluateLines(source, show='show', report=False)
								elif verify == 51:
												context.evaluateLines(source, show='writeToLocal')
								elif verify == 52:
...
#    context.displaySourceAsPng(source)
...
#    context.evaluateLines(source, show=None, partSelection=0, partLineType=None, keynote='G-', mode='major')
#    context.evaluateLines(source, show=None, partSelection=0, partLineType=None)
#    context.evaluateLines(source, show=None, partSelection=0, partLineType='generic')
#    context.evaluateLines(source, show=None, partSelection=0, partLineType='primary')
#    context.evaluateLines(source, show=None, partSelection=0, partLineType='bass', report=False)
