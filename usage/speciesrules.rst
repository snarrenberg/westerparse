...
#. Leaps of a fourth in the bass
   ...
   * When the whole-note line occurs in the bass: A fourth is permitted in the bass if there is a half- note in the upper line that
...
#. Localized rule E3 (L3). A non–tonic-triad pitch may be inserted within a measure if
...
#. Leaps of a fourth in the bass:
   ...
   * When the triplet-half- or quarter-note line occurs in the bass:
      ...
      #. A leap or a fourth may not occur within a measure unless the same measure includes a lower pitch that is

         * consonant with both pitches forming the fourth and
         * less than an octave below the bottom pitch of the fourth.
   ...
   * When the whole-note line occurs in the bass: A fourth is permitted in the bass if there is a note in the upper line that either
